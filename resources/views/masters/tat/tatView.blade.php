        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover no-margin">
                         ...
                         @foreach(\App\Model\Tat::all() as $tat)
                           <tr>
                             ...
                             <td>{{$tat->tat_time}}</td>
                             <td><a href="{{route('tat.edit',$tat->id)}}" class="btn btn-xs btn-danger"><i class="fa fa-edit"></i></a></td>
                             <td>
                                <button class="btn btn-xs btn-danger delete_po" type="button" data-toggle="modal" data-target="#confirmDelete" data-title="Delete" data-url="{{route('tat.destroy',$tat->id)}}">
                    ...
                    {!! \App\Model\Tat::paginate(5)->render() !!} 
                </div>
            </div>
        </div>
    </div>
