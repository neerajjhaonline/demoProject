    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">Edit Publishing</div>
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('publishing.update',$recId->id) }}" id="indexingEdit">
                        ...
                        <input type="hidden" name="pIn" value="{{$recId->rfi_start_dt or ''}}">
                        ...
                        <div class="form-group {{ $errors->has('status_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select name="status_id" class="form-control">
                                  ...
                                  @foreach(App\Model\Status::all() as $status)
                                    <option value="{{$status->id}}" {{($recId->status_id == $status->id || $status->id == old('status_id')?'selected':'')}} >{{$status->status_name}}</option>
                                  @endforeach  
                                </select>
                         ...
                         <div class="form-group{{ $errors->has('total_lane') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="total_lane" type="number" class="form-control" name="total_lane" value="{{ $recId->total_lane or old('total_lane') }}" min=1>
                        ...
                        <div class="form-group{{ $errors->has('no_of_lane') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="no_of_lane" type="number" class="form-control" name="no_of_lane" value="{{ $recId->no_of_lane or old('no_of_lane') }}" min=1>
                        ...
                        <div class="form-group{{ $errors->has('mode_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 row">
                                    ...
                                    <?php $str = json_decode($recId->mode_id)?>
                                    @foreach(App\Model\Mode::all() as $mode)
                                    <div class="col-md-6">    
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <input type="checkbox" value="{{$mode->id}}" name="mode_id[]" {{ (isset($str) && in_array($mode->id, $str) ? 'checked':'')}} >
                                          </span>
                            ...
                            <div class="col-md-6">
                                <select name="commodity_id" class="form-control">
                                  ...
                                  @foreach(App\Model\Commodity::where('type','Acceptable')->get() as $com)
                                    <option value="{{$com->id}}" {{($recId->commodity_id == $com->id || $com->id == old('commodity_id')?'selected':'')}} >{{$com->commodity_name}}</option>
                                  @endforeach  
                                </select>
                 ...
                 @if($indexing->requestType->name === 'COR')
                    <div id="correctionBlock"><!-- if Indexing is COR then correction ====== this block starts here -->
                        ...
                        <div class="form-group{{ $errors->has('proposed_comp_dt') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <div class="input-group date">
                                <input name="proposed_comp_dt" data-format="MM/dd/yyyy HH:mm:ss PP" type="text" class="form-control" id="proposed_comp_dt" value="{{$recId->proposed_comp_dt}}"></input>
                                <span class="input-group-addon add-on">
                                  <i data-time-icon="fa fa-clock-o" data-date-icon="fa fa-calendar">
                                  </i>
                                </span>
                        ...
                        <div class="form-group{{ $errors->has('proposed_act_dt') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <div class="input-group date">
                                <input name="proposed_act_dt" data-format="MM/dd/yyyy HH:mm:ss PP" type="text" class="form-control" id="proposed_act_dt" value="{{$recId->proposed_act_dt}}"></input>
                                <span class="input-group-addon add-on">
                                  <i data-time-icon="fa fa-clock-o" data-date-icon="fa fa-calendar">
                                  </i>
                                </span>
                ...
                @endif
                        <div class="form-group{{ $errors->has('oot') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="checkbox" value="1" name="oot" {{ ($recId->oot == '1' || old('oot') == '1' ? 'checked':'')}} >
                        ...
                        <div class="form-group{{ $errors->has('oot_remarkcomment') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="oot_remark" type="type" class="form-control" name="oot_remark" value="{{ $recId->oot_remark or old('oot_remark') }}">
                        ...
                        <div class="form-group{{ $errors->has('comment') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ootcomment_commentremark" type="type" class="form-control" name="comment" value="{{ $recId->comment or old('comment') }}">
