    ...
    public function index(Request $req)
    {
    	...
    	//if($accessType === 'ADMIN' || $accessType === 'SUPERADMIN' ){
    		$auditings = Auditing::rightJoin('process_queue','auditing.publishing_id', '=', 'process_queue.id')
                                ->rightJoin('indexing', 'indexing.id', '=', 'process_queue.indexing_id')
		  		...
		  		$auditings = $auditings->get();		
    				...
    				//dd($publishings);
    			     	...
    			     	//dd($publishings);
    	return view('dashboard',compact('auditings'));
    }
}
